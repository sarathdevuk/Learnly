      ...
      <li className="space-y-2">
        ...
        <ul className="space-y-2">
          <li className="flex items-center ">
            ...
            />
            <label htmlFor="tv" className="checkbox-label mt-2 ">
              TV, Audio-Video
            </label>
          </li>
          ...
          <li className="flex items-center">
            <input
              ...
              value=""
              className="checkbox h-4 w-4 "            />
            <label htmlFor="gaming" className="checkbox-label mt-2">
              Programming
            </label>
          </li>
          ...
          <li className="flex items-center">
            <input
              ...
              className="checkbox h-4 w-4 "
            />
            <label htmlFor="fashion" className="checkbox-label mt-2">
              Agricultural
            </label>
          </li>
          ...
          <li className="flex items-center">
            <input
              ...
              className="checkbox h-4 w-4 "
            />
            <label htmlFor="books" className="checkbox-label">
  ...
  <li className="space-y-2">
    ...
    <div className="flex flex-col mb-">
      ...
      <div className="mb-[0.125rem] block min-h-[1.5rem] pl-[1.5rem]">
        ...
        />
        <label htmlFor="radioNoLabel02" className="checkbox-label">
          Free
        </label>
      </div>
    </div>
