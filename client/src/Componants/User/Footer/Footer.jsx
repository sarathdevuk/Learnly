...
<footer className="bg-white dark:bg-gray-900">
    <div className="mx-auto w-full max-w-screen-2xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
              <a href="/" className="flex items-center">
                  <img src="/images/learnly-croped-logo.png" className="h-8 mr-3" alt="Learnly™ Logo" />
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
          <span className=" md:ml-2 text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://Learnly.com/" className="hover:underline">Learnly™</a>. All Rights Reserved.
          </span>
