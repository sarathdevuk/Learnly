  ...
  return (
    <>
      <div className="mb-4 pb-2 mt-7 ">
        <span className="font-medium text-2xl text-black">Manage {type}</span>
      </div>
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      {obj.tutor.firstName + obj.tutor.lastName}
                    </td>

                    <td className="px-6 py-4">{obj.duration}</td>
                    {obj.status ? (
                      <td className="px-6 py-4 text-green-700">Approved</td>
                    ) : (
                      <td className="px-6 py-4 text-red-700">Pending</td>
                    )}
